 ...
 */
final class Version20220929181845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pedidos (id INT AUTO_INCREMENT NOT NULL, clientes_id INT NOT NULL, direccion_id INT NOT NULL, estado_id INT NOT NULL, restaurante_id INT NOT NULL, platos_id INT NOT NULL, total DOUBLE PRECISION NOT NULL, fecha_entrega DATETIME NOT NULL, INDEX IDX_6716CCAAFBC3AF09 (clientes_id), UNIQUE INDEX UNIQ_6716CCAAD0A7BD7 (direccion_id), UNIQUE INDEX UNIQ_6716CCAA9F5A440B (estado_id), INDEX IDX_6716CCAA38B81E49 (restaurante_id), INDEX IDX_6716CCAAD77499C5 (platos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
